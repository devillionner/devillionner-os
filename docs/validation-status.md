...
| Fragments torrent integration | ✅ | ✅ | ⏳ | ⏳ | Existing host on 2026-09-24: `check-fragments` 28 OK / 0 FAIL; native Fragments/Transmission session, Caelestia dynamic GTK styling, 0.85 opacity, `Super+Q` background hide, GTK import watcher recovery, single-daemon cleanup, tray registration and dynamic torrent progress/speed submenu were exercised. User torrent data is not part of the Blueprint. |
