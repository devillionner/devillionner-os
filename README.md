...
- [Fragments torrent client](docs/fragments.md)
...
- CachyOS is deliberately treated as the technical base rather than the desktop brand: Caelestia owns top-bar/dashboard/lock identity, Cachy-Update background/tray UX is suppressed while its manual launcher is retained, CachyOS Kernel Manager stays available on demand, and pure CachyOS welcome/package-installer/wallpaper extras are removed.
