...
- CachyOS is deliberately treated as the technical base rather than the desktop brand: Caelestia owns top-bar/dashboard/lock identity, Cachy-Update background/tray UX is suppressed but its manual launcher is retained, and pure CachyOS welcome/package-installer/wallpaper extras are removed.
